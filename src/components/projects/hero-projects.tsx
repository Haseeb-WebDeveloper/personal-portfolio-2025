                ...
                <div className="section w-full h-full space-y-[20vw] md:space-y-[11vw]">
                    {heroProjects.map((project: IHeroProjects, index: number) => (
                        <div key={index} className="w-full flex flex-col lg:gap-[2vw] gap-[12vw]">
                            {/* Top Row */}
                            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:gap-[1vw] gap-[8vw]">
                                                ...
                                                <div className="flex justify-between items-center gap-[4vw]">
                                                    <div className="flex items-center lg:gap-[1vw] gap-[4vw]">
                                                        <Link href={testimonial.link} target="_blank" className="">
                                                            <Image className="w-[9vw] h-[9vw] md:w-[5vw] md:h-[5vw] lg:w-[4.2vw] lg:h-[4.2vw] rounded-full object-cover" src={testimonial.image} alt={testimonial.name} width={100} height={100} />
                                                        </Link>
                                                        <div>
                                                            <p className="text-[5vw] md:text-[4vw] lg:text-[1.4vw] font-medium lg:tracking-normal">{testimonial.name}</p>
                                                            <p className="text-[4vw] md:text-[3vw] lg:text-[1.1vw] font-medium lg:tracking-normal">{testimonial.role}</p>
                                                        </div>
                                                    </div>
