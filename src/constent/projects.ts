        ...
        testimonial: [
            {
                ...
                feedback: "We first worked with Haseeb on our India Masters project and were super happy with the result. So when it came time to build our own agency website, we knew exactly who to call. It was a big site—25+ pages—and Haseeb handled everything so smoothly, from complex animations to seamless CMS integration.",
                rating: 5,
